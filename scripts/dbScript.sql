...
-- tabla de facturas de mercados
CREATE TABLE facturasMercado (
    id INT AUTO_INCREMENT PRIMARY KEY,
    mercado VARCHAR(255) NOT NULL,
    propietario VARCHAR(255) NOT NULL,
    DNI VARCHAR(255) NOT NULL,
    permiso_operacion VARCHAR(50) NOT NULL,
...
ALTER TABLE localidades ADD COLUMN permiso_operacion VARCHAR(255);